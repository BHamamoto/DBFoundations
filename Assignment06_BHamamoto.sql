...
-- 2024-02-21,BHamamoto,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_BHamamoto')
	 Begin 
	  Alter Database [Assignment06DB_BHamamoto] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_BHamamoto;
	 End
	Create Database Assignment06DB_BHamamoto;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_BHamamoto;
...
Create View vInventoriesByEmployeesByDates
	...
	SELECT TOP 1000000
	i.InventoryDate,
	EmployeeFullName = concat(e.EmployeeFirstName, ' ', e.EmployeeLastName)
...
Create View dbo.vInventoriesByProductsByCategoriesByEmployees
	...
	CONCAT(vEmployees.EmployeeFirstName, ' ', vEmployees.EmployeeLastName) AS EmployeeFullName, 
	CONCAT(vManagers.EmployeeFirstName, ' ', vManagers.EmployeeLastName) AS ManagerFullName
FROM vCategories
	JOIN vProducts on vCategories.CategoryID = vProducts.CategoryID
	...
	JOIN vEmployees as vManagers on vManagers.EmployeeID = vEmployees.ManagerID
...
SELECT TOP 1 * FROM [dbo].[vInventoriesForChaiAndChangByEmployees];
